...
<div className="mx-3 my-6  ">
 <h1 className="text-white text-7xl my-11 font-serif flex justify-center"><b><u>Projects:</u></b></h1>
 <p className="text-rose-700 text-5xl my-11 font-serif flex justify-center"> <b>Here are some my projects</b></p>
</div>
<section className="sm:grid grid-cols-3" >
 <div data-aos="zoom-in-up" className="bg-gray-800  h-25 mx-4 my-3 w-30 rounded-2xl cursor-pointer hover:scale-105">
  ...
  <h1 className="text-2xl mx-11  my-3 font-serif text-rose-700"><b>E-Commerce Website</b></h1>
