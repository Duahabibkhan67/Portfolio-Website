...
export default function SKill(){
 return(
  <div>
   <h1 className=" text-5xl lg:text-6xl text-rose-700 font-serif flex justify-center my-11 "><b>Skills:</b></h1>
   <p className="text-3xl lg:text-4xl text-white flex justify-center font-serif my-5 "><u>Here are my Skills:</u></p>
   <section className="sm:grid grid-cols-3">
    ...
    <div >
    <Image className="mx-9 my-2 hover:scale-110"  height={200}  width={200} src="/javalogo.png" alt="java" />
    </div>
    <div >
    ...
    <div >
    <Image className="mx-9 my-9 hover:scale-110" height={200}  width={200} src="/react logo.png" alt="react" />
    </div>
   </section>
  </div>
 )
