...
<section className="sm:grid grid-cols-3 mx-6 my-11">
 <div data-aos="fade-right"
  ...
  <Image className="bg-blue-600 my-2 rounded-full sm:m-20" height={100} width={100} src="/web logo.png" alt="weblogo"></Image>
 <h1 className="sm:text-4xl my-2 text-white"><b>Web Development</b></h1>
 <p className="sm:text-1xl text-white ">Expert web Development service to bring your ideas to life.From conceptualization to deployment,
 ...
 <div data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" className="mx-4 hover:scale-105">
  <Image className="bg-orange-600 my-2  rounded-full sm:m-20" height={100} width={100} src="/designlogo.png" alt="designlogo"></Image>
 <h1 className="sm:text-4xl my-2 text-white"><b>Web Design</b></h1>
 <p className="sm:text-1xl text-white sm:mx-2 ">Creative web designing solutions to captivate
 ...
 <div data-aos="fade-right"
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" className="mx-4 hover:scale-105" >
  <Image className="bg-green-700 my-2 sm:m-20 rounded-full" height={100} width={100} src="/responsivelogo.png" alt="responsivelogo"></Image>
 <h1 className="sm:text-4xl my-2 text-white"><b>Responsive Web Design</b></h1>
 <p className="sm:text-1xl text-white  sm:mx-2">Responsive web design services to ensure seamless user exprience
